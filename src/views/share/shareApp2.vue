    ...
    <div class="shareAppCon">
        ...
        <div>
            <div class="AppInfoCon">
                <img :src="imgSrc">
                <div class="appName">万才佳薪宝</div>
                <div class="appDescribe">一个能赚钱的APP，让你薪上加薪！</div>
    ...
    export default {
        data(){
            return {
                shareShow:false,
                showHead:false,
                imgSrc:require('@/assets/images/ios-template-1024@2x.png'),
                androidLink:'',
            }
        },
        mounted(){
...
//             },
            ...
            downloadApp(){
                ...
                let url;
                if(ver){ //ios跳转下载地址
                   url = 'https://itunes.apple.com/cn/app/id1477306402?mt=8';
                }else{ //安卓
