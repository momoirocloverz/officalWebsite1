<template>
    <div class="g-publicity">
        <img class="u-publicity-img" src="../assets/images/firstShow.jpg" v-if="showBac"/>
        <div class="u-first-btn" @click="()=>{this.showBac=false}" v-if="showBac">

        </div>
        <img class="u-publicity-img" src="../assets/images/publicity.png" v-if="!showBac"/>
        <div class="u-publicity-form" v-if="!showBac">
            <div class="mb40">
    ...
    export default {
        ...
        methods: {
            ...
            shareWechat: function () {
                ...
                let shareImg = 'http://www.10000rc.com/2.0/wgw/img/logo-share.png';
                let data = {
                    url: url
                };
                    ...
                    if (res.data.respCode == 0) {
                        ...
                        wx.ready(function () {
                            let cfg = {
                                ...
                                "desc": "零成本，解决社保入税后的合法合规！9月限量免费！",//摘要,如果分享到朋友圈的话，不显示摘要。
                                "title": '社保成本剧增，企业出路在哪？',//分享卡片标题
